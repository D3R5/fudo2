...
const ProductList = () => {
  ...
  const handleSave = () => {
    api.put(`/products/${editingProduct}`, formData)
      .then(() => {
        fetchProducts();
          ...
          <li key={product.id}>
            {editingProduct === product.id ? (
              <div>
                ...
                <input name="price" value={formData.price} onChange={handleChange} placeholder="Precio" />
              ...
              <div>
                ...
                &nbsp;&nbsp;<button onClick={() => handleEdit(product)} className='button-edit'>Editar</button>
